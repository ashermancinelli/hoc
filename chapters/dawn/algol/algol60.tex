...
for formal specification of programming languages, \parencite{backus_ial_1959}.
...
in \parencite{landin_algol_lambda_1965}, \citeauthor{landin_algol_lambda_1965}
attempted to formalize the semantics of ALGOL 60 by translating them into
the \lamc
\footnote{This is more thoroughly discussed in \cref{sec:landin-lambda-calculus}}
.
...
\inputminted[frame=single,linenos]{python}{chapters/dawn/callbyname1.py}
...
\inputminted[frame=single,linenos]{python}{chapters/dawn/callbyname2.py}
...
\inputminted[frame=single,linenos]{pascal}{chapters/dawn/knuth-man-boy-test.a68}
...
\inputminted[frame=single,linenos]{pascal}{chapters/dawn/jensens-device.a68}
...
\inputminted[frame=single,linenos]{pascal}{chapters/dawn/swap-error.a68}
