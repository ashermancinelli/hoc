...
=== The IAL and the ALGOrithmic Language
...
#todo[who were these people? Add some narrative. Maybe of Naur, then tie in with Backus.]
They arrived at the following objectives
#cite(<perlis_samelson_1958_preliminary_report_ial>, form: "normal"):

#enum(
  [The new language should be as close as possible to standard mathematical
...
and diagnostic features" #cite(<burroughs1963bac220>, form: "normal").
...
The first issue of the #emph[ALGOL Bulletin] was issued in March of 1959 out of Copenhagen
...
Among the more intriguing technical features of ALGOL 58 were its essential
	...
	#strong[#emph[begin… end]] delimiters for creating a single (compound) statement from simpler
	ones; the flexibility of the procedure declaration and the #strong[#emph[do]] statement for
	...
	former but not the latter are the #strong[#emph[do]] which was removed as a concept (although
