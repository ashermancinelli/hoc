...
\begin{table}[h!]
	...
	\begin{tabularx}{\linewidth}{lX}
		...
		1953 & Hopper's team completes the A-1                                                                               \\
		     & Hopper's team completes the A-2 (featuring \textit{pseudocode}, closer to modern notion of \textit{compiler}) \\
		     & Hopper gives presentation to UNIVAC users on the A-2                                                          \\
		     & Numerous US government agencies have adopted the A-2                                                          \\
		1954 & John Backus at IBM begins work on \FTN{}                                                                      \\
	...
	\label{tab:early-compiler-timeline}
\end{table}
