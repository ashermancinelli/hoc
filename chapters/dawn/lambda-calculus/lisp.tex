...
\subsubsection{FORTRAN Lisp Processing Language}
...
\subsubsection{McCarthy's Contributions}
...
\citep{weizenbaum_funarg_explained_1968}
and
\citep{moses_function_of_function_1970}
...
\subsubsection{The First Lisp Compilers}
...
\todo{Continue here: \citetitle[6.2.1 From Lisp 1.5 to PDP-6 Lisp: 1960-1965]{steele_evolution_lisp_96}.
	First cross-compiler to bring up a language.
	Just had to port/cross compile the "subconscious" \cite[pp 289]{allen_anatomy_of_lisp_1978}.
...
\todo{mention \gls{lisp-machine}s so we can refer back to them in \cref{sec:gnu}}.
\todo{mention \parencite{kessler_peep_optimizations_1984} compiler optimizations
