...
\begin{quotation}
	...
	\begin{table}[h!]
		\centering
		\begin{tabularx}{0.3\columnwidth}{cX}
			\toprule
			Designation          & Function                 \\
			\midrule
			F\textsuperscript{1} & Square Root              \\
			F\textsuperscript{2} & sine                     \\
			F\textsuperscript{3} & cosine                   \\
			F\textsuperscript{4} & tangent                  \\
			F\textsuperscript{5} & sine\textsuperscript{-1} \\
			\bottomrule
		\end{tabularx}
	\end{table}
