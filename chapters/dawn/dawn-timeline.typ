...
//		{1953.3, "Hopper's team completes the A-2 (featuring \\textit{pseudocode}, closer to modern notion of \\textit{compiler})",delta=-.2},
//		{1953.6, "Hopper gives presentation to UNIVAC users on the A-2"},
//		{1953.9, "Numerous US government agencies have adopted the A-2"},
//		{1954.5, "John Backus at IBM begins work on \\FTN{}"},
//		{1954.9, "Nora Moser of US Army sends Hopper modifications to the A-2"},
//		{1957, "John Backus at IBM released the first \\FTN{} compiler, the first commercial compiler"},
//		},
//		})
...
#figure(
  ...
  [Event],
  [1942],
  [Zuse conceptualizes first high-level language #emph[Plankalkül]],
  [1944],
  [Aiken and IBM's Automatic Sequence Control Calculator (#emph[Mark I]) started working],
  [1946],
  [Hopper's Mark I manuscript published],
  [1949],
  [Hopper's contract at Harvard Computation Lab ends; she joins EMCC the same year],
  [],
  [Stiefel at the ETH learns about Z4],
  [1950],
  [Rutishauser ran Zuse's Z4 as a compiler at ETH],
  [],
  ...
  [],
  [Hopper begins work on the A-0 compiler for the UNIVAC I],
  [1952],
  [Hopper presents #emph[Automatic Programming] at ACM],
  [],
  [Alick Glennie develops compiler for Mark I],
  [1953],
  [Hopper's team completes the A-1],
  [],
  [Hopper's team completes the A-2 (featuring #emph[pseudocode], closer to modern notion of #emph[compiler])],
  [],
