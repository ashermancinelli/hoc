...
Backus would later describe this group in #cite-title(<Backus_1980_Programming_in_America_in_1950s>):
...
#cite(<brown_carr_automatic_onr_symposium_1954>, form: "author") summarize the recent developments
of #emph[automatic programming] techniques like #emph[pre-translation] and #emph[running-translation],
...
Many "professional" machine users strongly opposed the use of decimal
	...
	#cite(<brown_carr_automatic_onr_symposium_1954>, form: "normal")
]
...
towards user-friendliness, and the sentiment #cite(<brown_carr_automatic_onr_symposium_1954>, form: "author")
...
At that time, most programmers wrote symbolic machine instructions exclusively
	...
	Therefore, it was agreed, #strong[compilers could only turn out code which would be
		intolerably less efficient than human coding]…
]
...
This will be the focus of Chapter #xref(<chap:software>, capital: false).
...
sceptics would be right#cite(<backus_heising_fortran_1964>, form: "normal").
