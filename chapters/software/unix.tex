...
\section{Standardization of C}

\todo{using pcc as a reference compiler became impractical.
...
In 1974, Brian Kernighan and Linda Cherry developed one such program called \texttt{eqn}
...
The newly created Computing Sciences Research Center at the Labs
