...
colloquially known as \textit{The Dragon Book} (\citep{the_dragon_book_aho_ullman_sethi_1986})
and his book with John Hopcroft on algorithms, \citep{aho_hopcroft_algorithms_1974}.
...
Bjarne was a Danish computer scientist who came to the labs from \todo{where?}
with a background in using SIMULA for event-driven simulations, and wanted to bring
that experience to C.

\subsubsection{David MacQueen, Joined 1981}
