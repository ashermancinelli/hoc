...
#todo[Bill Gates and Paul Allen (Microsoft) | Microsoft BASIC (1975) |
...
Joy worked on BSD at Berkeley, worked on Pascal compilers there.

#quote(block: true)[
But I came across Bill Joy in the computer room where he was busily
	hacking away and he said "Hi, I'm Bill Joy, this is what we're
	working on here-a Pascal system that runs under Unix."
...
#cite(<salus_reed_daemon_gnu_penguin_2008>, form: "normal").
