...
I can recommend #emph[The Idea Factory] for a more comprehensive account.
...
#cite(<the-first-computers-2002>, form: "normal", supplement: [The Structures of Computation]):
#quote(block: true)[
...
While this description was correct about the #emph[direction] compiler engineering
...
Despite great strides in software, programming always seemed to be in a state of crisis and
	...
	#footnote[Readers may find it entertaining that Ceruzzi describes COBOL and FORTRAN
		as obsolete #emph[by 1968]; both are still heavily used in some industries,
		and one of the very first compilers to adopt MLIR (to be discussed in a later chapter)
		is a Fortran compiler#cite(<spickett_flang_levels_up_2025>, form: "normal").]. Although
	...
	#cite(<history_of_modern_computing_2003_ceruzzi>, form: "normal")
]
...
Another factor that influenced the development of Fortran was the economics
	...
	center was usually at least as great as the cost of the computer itself…
...
#cite(<structured_programming_1972>, form: "normal") in #cite(<structured_programming_1972>, form: "year")
from #cite(<structured_programming_1972>, form: "author").
This surveyed several diverse techniques for structuring programs.
It was the notion that control flow jumping around programs (as with #mono-text("goto"))
