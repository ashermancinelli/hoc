...
You might imagine two primary ways to organize this document.
Firstly, you might imagine we pick a topic and narrate its history from start
to finish.
Each thread of history would be discussed exhaustively.
Alternatively, we could take slices of history, examining
developments in compiler technology in relation to other efforts going on at
the same time.
I chose the latter format so the connections between the compiler efforts are clearer,
but the former would also be valid.
