...
In the beginning of software development, much of it #emph[was already] given
...
you #emph[had] to ship the code for your programs, and there was nothing in between your
...
the A-2 compiler (see Section #xref(<sec:a1-a2-compilers>, capital: false)), for which the Remington Rand company
...
was distributed under a license that would today be considered similar to #gls-upper("foss").
...
#todo[gnu linux c llvm python; Facebook php->c++
	compiler;]

#todo[lattner tried to get llvm in the gnu project; new licensing,
