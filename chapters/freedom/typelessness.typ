...
== Should Your Language Be Typed?


When Lamport et al. (#cite-title(<lamport_should_lang_be_typed_1999>))
presented on these concepts, people were so offended - Backus's
position in #cite-title(<backus_can_liberated_from_vn_style_1978>) had gained lots of
influence in some circles, so the suggestion that we should #emph[regress] into a
