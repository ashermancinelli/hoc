...
Stallman recals in \parencite{stallman_the_gnu_project} that he thereafter obtained
the code for a cross-platform compiler from Lawrence Livermore National Laboratory
...
Portable Optimizer
\footnote{This optimizer was also called PO,
	which stands for \textit{peephole optimizer} and not \textit{portable optimizer}},
...
He considered using Trix, which was a research project from MIT
\parencite{stallman_kth_transcript_1986}.
