...
\acrshort{rtl} was GCC's only \acrshort{ir} for many years,

\subsection{GCC in C++}

Bjarne's inital C++ compiler was a relatively slow and fragile macro-based compiler
called \texttt{cfront}, which targeted C code instead of machine code directly.
C++'s reputation was not great in the 1990s, but was helped along by the GNU
C++ compiler \texttt{g++}, which outperformed \texttt{cfront}, generated native
