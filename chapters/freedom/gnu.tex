...
The part of the compiler generating the \arcshort{ir} does not have to
...
PO also performed \acrlong{cfg} simplification and \acrlong{dce} by identifying redundant nodes
in the \acrshort{cfg}.
...
\begin{quotation}
	...
	noted, closely synchronized) code trees were formally combined, ending a long fork and incorporating the many bug fixes and enhancements made in EGCS into GCC. This is why EGCS is often
