...
In these instances, I've tried to cross-reference the content to readers that
would rather follow a particular topic from start to finish are able to, but
the threads between histories of the same time period are preserved.
