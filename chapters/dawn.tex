...
In a turn of events Konrad Zuse was made aware of Aiken's Mark I through his daughter:
\begin{quotation}
...
In 1946, Commander Edmund Berkeley wrote a report on the conditions at the
...
Rand's team did not have nearly the programming expertise nor the personnel
...
% Let us turn to the paper in which Hopper announced her A-0 compiler, the 1952
% \citetitle{education_of_a_computer_1952_hopper}, which she presented at a
% Pittsburgh ACM meeting.

% \todo{it was really a linker. copied subroutines into a program, adjusted addresses.}

% \begin{figure}[h]
%     \centering
%     \includegraphics[width=.5\textwidth]{resource/gh_education_of_a_computer_type_fig_6.png}
%     \caption{Depiction of \textit{type-B compilation} from \citetitle{education_of_a_computer_1952_hopper}.  \cite{education_of_a_computer_1952_hopper}}
...
including Irving Ziller, \todo{list other members}.
...
\citetitle{Backus_Herrick_1954_Speedcoding}
...
\todo{the priesthood didn't like fortran bc it made things easy.
Backus resisted this urge at everypoint in his career.
