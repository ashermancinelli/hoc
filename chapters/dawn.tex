...
Zuse's machines prior to the Z4 were destroyed during the war. \todo{Zuse's Z4
    was a strange machine with bespoke memory and instruction set.This affected how
...
manual.\cite{annals_of_the_computation_laboratory_of_harvard_university_1946}:% \todo{% ENIAC, could not be programmed (had to be rewired to be programmed)% but was real fast. Aiken's Mark I.% Fall 1944, Aiken wants to record technical developments at Harvard Computation Laboratory (as book),% chose Hopper, to her disagreement. Finished 561 page manuscript, published 1946.% She believed she was chosen for "clear, fluid prose."% her time as a math teacher made her good at writing/explaining things.% would force students to write essays on math topics and would grade harshely.% "it was no use trying to learn math unless they could communicate with other people."% Aiken and Hopper knew a large/diverse audience would need to understand it for it to% be successful; high value on good writing+communication.% Aiken's strict heirarchy+meritocracy allowed her to compete with the men.% IBM tried to steal all the credit for the Mark I from Aiken.% aiken distaste for being assigned woman officer, but meritocracy.% }\section{Hopper and the Mark I's Manual}Here we drift into some general computing history, mostly because it was soformative for Hopper, who was in turn so formative in the development ofcompilers.Her manual for the Mark I began with a detailed and dramatic retelling ofcomputing history, opening with the following quote from Charles Babbage andculminating with the Mark I
\begin{quotation}If, unwarned by my example, any man shall undertake and shall succeed inreally constructing an engine embodying in itself the whole of the executivedepartment of mathematical analysis upon different principles or by simplermechanical means, I have no fear of leaving my reputation in his charge, for healone will be fully able to appreciate the nature of my efforts and the valueof their results.
\end{quotation}
...
\end{quotation}
Rand's team did not have nearly the programming expertise nor the personnelto 
...
She dubbed her A-0 as a compiler because it was compiling subroutines from a
...
\todo{A-0 and A-1 really had mneumonics for routines that the compiler new about}.
% \section{The A-1}
...
%    locations 688 through 721 and to store the sum in cell 945. Assume further that 
%    cell 1013 contains the number zero and that instruction 416 is the next 
%    instruction to be executed. The sequence of instructions shown below could be 
...
\todo{explain BNF and lang specs, tie in with GH algol work}\cite{Backus_1980_Programming_in_America_in_1950s}:
\begin{quotation}
    The notation for syntax description known as BNF offers another example of a
    development which began with a prosaic recognition of a need. After involvement
    with two language design efforts-FORTRAN and IAL (ALGOL 58)-it became clear, as
    I was trying to describe IAL in 1959, that difficulties were occurring due to
    ...
    precise description was noted, it became obvious that Post's productions were
    well suited for that purpose. I hastily adapted them for use in describing the
    syntax of IAL. The resulting paper [5] was received with a silence that made it
    seem that precise syntax description was an idea whose time had not yet come.
    As far as I know that paper had only one reader, Peter Naur. Fortunately, he
    had independently recognized the need for precision; he improved the notation
    ...
    syntax of ALGOL 60 in the definitive paper on that language. He thus proved the
