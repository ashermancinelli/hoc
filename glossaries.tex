...
\newglossaryentry{backedge}{
	name={back-edge},
	description={A back-edge is an edge in the \gls{cfg} that returns execution from the end of a loop body back to the beginning of the loop, or the loop's \gls{header}}
}
