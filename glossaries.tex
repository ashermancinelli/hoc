...
\newacronym[
	description={A subset of computing primarily concerned with scientific applications
	on very large-scale systems, often referred to as supercomputers or compute clusters}
]{hpc}{HPC}{high-performance computing}

\newacronym[
	description={A compiler company based in Portland, Oregon that specialized in
	\arcshort{hpc} compilers}
]{pgi}{PGI}{The Portland Group}
...
\newacronym[
	description={The software foundation started by Richard Stallman with the goal of supporting free software}
