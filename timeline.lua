function draw_timeline(config)
    ...
    local height = config.height or 8.4
    ...
    tex.sprint("description/.style={text width=8cm, font=\\small, anchor=west}]")
...
function draw_timeline(config)
    ...
    if not text_width then
        ...
        local textwidth_pt = tex.dimen.textwidth / 65536  -- Convert sp to pt
